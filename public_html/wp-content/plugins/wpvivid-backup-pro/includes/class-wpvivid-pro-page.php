...
class WPvivid_pro_page
{
    ...
    public function connect_account(){
        ...
        try
        {
            ...
            $server=new WPvivid_Connect_server();
            $ret=$server->login($email,$user_info,true,$use_token);
    ...
    public function init_page()
    {
        ...
        <div class="wrap">
            ...
            <h1><?php esc_attr_e( 'WPvivid Plugins - License', 'WpvividPlugins' ); ?></h1>
                            ...
                            <div class="wpvivid-backup">
                                <div class="wpvivid-welcome-bar wpvivid-clear-float">
                                    <div class="wpvivid-welcome-bar-left">
                                        ...
                                        <span class="about-description">Enter your email and license to activate WPvivid plugins and get plugin updates and support.</span>
                                    </div>
